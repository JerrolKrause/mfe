...
module.exports.album = fs.readFileSync(path.join(__dirname, 'album.gql'), 'utf8');
module.exports.albums = fs.readFileSync(path.join(__dirname, 'albums.gql'), 'utf8');
...
module.exports.photo = fs.readFileSync(path.join(__dirname, 'photo.gql'), 'utf8');
module.exports.photos = fs.readFileSync(path.join(__dirname, 'photos.gql'), 'utf8');
